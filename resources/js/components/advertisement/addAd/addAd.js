...
function AddAdvertisement() {
    ...
    function onSubmit(event) {
        ...
        axios({
            method: 'post',
            url: 'http://localhost/wdm_phase4/React/src/api/' + 'addAd.php',
            headers: {
            ...
            .then(result => {
                ...
                x.className = "show";
                x.innerText = 'Advertisement Created Successfully';
                setTimeout(function(){
            ...
            .catch(error => {
                ...
                x.innerText = 'Advertisement already present';
                setTimeout(function(){
                     x.className = x.className.replace("show", "");
            }, 5000);
    ...
    return(
      ...
      <div className="font-oswald d-flex flex-direction-row w-100  justify-center sideNavHeader"> Add Advertisement
      </div>
      <div className="form">
        <form className="d-flex flex-direction-column w-100 align-items-center" action="#" method="post" onSubmit={onSubmit}
          ...
          <div className="d-flex flex-direction-column createClub-container">
            ...
            <div className="d-flex w-100 flexdirection-row justify-center joinClubButton">
              ...
              <button className="btn club" type="submit">Add Advertisement</button>
            </div>
          </div>
        </form>
      </div>
